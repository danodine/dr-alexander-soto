...
export const doctorProfile = {
  ...
  title: "Traumatologo especialista en pie y tobillo en Quito",
  specialty:
    "Traumatologia y ortopedia con subespecialidad en cirugia de pie y tobillo",
  description:
    "Atencion especializada en traumatologia, ortopedia, cirugia de pie y tobillo, miembro inferior, artroscopia, lesiones deportivas y recuperacion funcional en Quito, Ecuador.",
  phone: "+593990165538",
  ...
  address: {
    streetAddress: "Av. Mariana de Jesus OE7-02 y Nuno de Valderrama P.B.",
